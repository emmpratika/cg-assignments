...
void loadObject(const char* objFile,
	...
	GLuint& uvbuffer) 
{
	bool file = loadOBJ(objFile, vertices, uvs, normals);
...
void loadTexture(const char* textureFile, int TEXTURE, const GLuint& textureID) {
...
void bindTexture(GLuint& TextureID, const GLuint& programID, )
...
int main(void)
{
	...
	window = glfwCreateWindow(800, 8000, "Give window title", NULL, NULL);
